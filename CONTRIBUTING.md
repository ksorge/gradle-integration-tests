...
In order to keep a consistent codebase regarding format, all PRs *must*
adhere to the standard IntelliJ's code format.
Before committing your files, format the code by selecting the appropriate 
checkbox in the commit dialog or by hand.
